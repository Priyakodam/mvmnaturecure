...
const Home = () => {
  const doctors = [
    {
      ...
      image: 'https://mvmnaturecure.digitalcadenz.com/admin//assets/profile_pic/mvm_new_doc.png',
    },
    {
      name: 'Dr. Vidhi Kasliwal',
      qualification: 'BDS',
      specialization: 'General and Restorative Dentistry',
      image: 'https://mvmnaturecure.digitalcadenz.com/admin//assets/profile_pic/mvm_doc.png',
    },
    {
      name: 'Dr. Veena Suresh',
      qualification: 'MBBS, DGO',
      specialization: 'Gynaecology and Obstetrics',
      image: 'https://mvmnaturecure.digitalcadenz.com/admin//assets/profile_pic/mvm_latest_doc.png',
    },
  ];
  ...
  return (
    <div>
      ...
      {/* Our Experts Section */}
      <div className="serviceheading">Our Experts</div>
