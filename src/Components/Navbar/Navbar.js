  ...
  return (
    <header>
      <div>
        <img
          src={logo}
          style={{ width: "60px", height: "60px", marginRight: "40px" }}
        />
      ...
      <nav ref={navRef}>
        ...
        <a style={{ fontWeight: "700" }} href="/about">
          About Us
        </a>
        {/* Dropdown for Services */}
        <div className="dropdown">
          <a style={{ fontWeight: "700" }} href="/services" className="dropbtn">
            Our Services
          </a>
          <div className="dropdown-content">
            ...
            <a href="/services/ayurvedic-consultations">
              Ayurvedic Consultations and Panchakarma
            </a>
          </div>
        </div>
        <a style={{ fontWeight: "700" }} href="/doctor">
          Our Doctors
        </a>
        <a style={{ fontWeight: "700" }} href="/contact">
          Contact Us
        </a>
        <a style={{ fontWeight: "700" }} href="/pricing">
          Pricing
        </a>
